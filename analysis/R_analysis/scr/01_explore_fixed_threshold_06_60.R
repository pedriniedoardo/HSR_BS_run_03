...
#   # head(y@meta.data)
#   #
#   saveRDS(object = y,file = paste0("../../out/object/datasc_fix_filter_norm_doublet_06_60_",x,".rds"))
# })
# 
...
# # save the total meta
# meta_total_doublet %>%
#   write_tsv("../../out/table/meta_datasc_fix_filter_norm_doublet_06_60.tsv")
# 
...
#   saveRDS(object = datasc_filter,file = paste0("../../out/object/datasc_fix_filter_norm_doublet_Singlet_06_60_",x,".rds"))
# })
# 
