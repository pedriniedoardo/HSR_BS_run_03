...
df_tot %>%
  ...
  theme(strip.background = element_blank())
ggsave("../../out/image/06_UMAPggplot_annotationConfident_HIF1A_count.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/06_UMAPggplot_annotationConfident_HIF1A_count2.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/06_UMAPggplot_annotationConfident_HIF1A_minmax.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  #       panel.border = element_rect(colour = "black", fill = NA))
  theme(strip.background = element_blank())
ggsave("../../out/image/06_UMAPggplot_annotationConfident_HIF1A_proppos.pdf",width = 13,height = 12)
...
df_tot %>%
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("../../out/image/06_violin_annotationConfident_HIF1A.pdf",width = 15,height = 10)
...
df_avg |>
  ...
  facet_wrap(~expertAnno.l1,scales = "free")
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_treat.pdf",width = 9,height = 9)
...
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_treat_scale.pdf",width = 14,height = 3)
...
# save the table
df_avg2 %>%
  write_tsv("../../out/table/06_df_avg_cellTypeTreat_HIF1A_BS.tsv")
...
df_avg2 |>
  ...
  facet_wrap(~expertAnno.l1,scales = "free")
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_treatFull2.pdf",width = 9,height = 9)
...
ggsave("../../out/image/06_DE_annotationConfident_HIF1A_sc.pdf",width = 12,height = 9)
...
ggsave("../../out/image/06_DE_annotationConfident_HIF1A_bulk_PairWiseTest.pdf",width = 9,height = 9)
...
ggsave("../../out/image/06_DE_annotationConfident_HIF1A_bulk_PairWiseTest2.pdf",width = 9,height = 9)
...
df_avg_cellType |>
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_cellType.pdf",width = 6,height = 5)
...
df_avg_cellType2 |>
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))+scale_color_manual(values = c("black","red"))
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_cellType2.pdf",width = 6,height = 5)

# save the table
df_avg_cellType2 |> 
  write_tsv("../../out/table/06_df_avg_cellType_HIF1A_BS.tsv")
...
df_avg_disease |> 
  write_tsv("../../out/table/06_df_avg_disease.tsv")
...
# save the table
df_avg_disease2 |> 
  write_tsv("../../out/table/06_df_avg_disease_HIF1A_BS.tsv")
...
df_avg_disease |>
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_disease.pdf",width = 6,height = 5)
...
#       panel.border = element_rect(colour = "black", fill = NA))
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/06_dotplot_annotationConfident_HIF1A_expressionAvg_disease2.pdf",width = 6,height = 5)
