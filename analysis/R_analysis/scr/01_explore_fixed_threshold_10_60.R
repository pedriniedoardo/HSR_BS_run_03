...
#     mutate(test = percent.mt < 10 & nFeature_RNA > 1000 & nFeature_RNA < 6000) %>% 
#     pull(test)
#   
...
# c("orig.ident","nCount_RNA","nFeature_RNA","percent.mt","percent.ribo","mt_bin","treat","clone","doxy","exposure","time","ID","test","not_outlier","RNA_snn_res.0.8","seurat_clusters","pANN","DF")
# #
...
#   meta <- y@meta.data
#   colnames(meta) <- c("orig.ident","nCount_RNA","nFeature_RNA","percent.mt","percent.ribo","mt_bin","treat","clone","doxy","exposure","time","ID","test","not_outlier","RNA_snn_res.0.8","seurat_clusters","pANN","DF")
#   y@meta.data <- meta
#   # head(y@meta.data)
#   #
#   saveRDS(object = y,file = paste0("../../out/object/datasc_fix_filter_norm_doublet_10_60_",x,".rds"))
# })
# 
...
# # save the total meta
# meta_total_doublet %>%
#   write_tsv("../../out/table/meta_datasc_fix_filter_norm_doublet_10_60.tsv")
# 
...
#   saveRDS(object = datasc_filter,file = paste0("../../out/object/datasc_fix_filter_norm_doublet_Singlet_10_60_",x,".rds"))
# })
# 
