...
# # read in the data --------------------------------------------------------
data.combined <- readRDS("../../out/object/data.combined_harmonySkipIntegration_AllSoupX_00600_06000_15.rds")
...
ggsave(plot=plot03,"../../out/image/UMAPCluster_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 4)

# main umap cell cycle
plot04 <- DimPlot(data.combined, reduction = "umap", group.by = "Phase",raster = T)
ggsave(plot=plot04,"../../out/image/UMAPPhase_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 4)
...
ggsave(plot=plot05,"../../out/image/UMAPClusterggplot_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 3)
...
ggsave(plot=plot05_alt,"../../out/image/UMAPClusterggplot2_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 3)
...
ggsave(plot = plot051,"../../out/image/UMAPRibo_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 3)
...
ggsave(plot = plot052,"../../out/image/UMAPMito_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 3)
...
ggsave(plot = plot053,"../../out/image/UMAPnCount_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 3)
...
plot06 <- data2 %>%
  ...
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave(plot=plot06,"../../out/image/UMAPClusterSplit_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 13,height = 9)
...
df_summary <- df_meta %>%
  ...
  ungroup() %>%
  mutate(prop=n/tot)
write_tsv(df_summary,"../../out/table/summary_harmonySkipIntegration_AllSoupX_00600_06000_15.tsv")
...
ggsave(plot=plot07,"../../out/image/summary_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 5,height = 4)

plot08<-df_summary %>%
  mutate(ID = factor(ID)) %>%
  ggplot(aes(x=seurat_clusters,y=prop,fill=ID))+geom_col(position = "dodge")+theme_bw()+scale_fill_manual(values = col_pal)
ggsave(plot=plot08,"../../out/image/summaryDodge_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 8,height = 4)
...
test_short <- DotPlot(data.combined, features = shortlist_features_list, dot.scale = 8,cluster.idents = T) +
  RotatedAxis()
ggsave(plot = test_short,"../../out/image/Dotplot_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 13,height = 5)

test_short2 <- DotPlot(data.combined, features = shortlist_features_list2, dot.scale = 8,cluster.idents = T) +
  RotatedAxis()
ggsave(plot = test_short2,"../../out/image/Dotplot2_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 13,height = 5)

test_long <- DotPlot(data.combined, features = shortlist_features_list_long, dot.scale = 8,cluster.idents = T) +
  RotatedAxis()

ggsave(plot=test_long,"../../out/image/DotplotLong_harmonySkipIntegration_AllSoupX_00600_06000_15.pdf",width = 25,height = 5)
...
sobj_total_h.markers %>%
  write_tsv("../../out/table/FindAllMarkers_harmonySkipIntegration_AllSoupX_00600_06000_15.tsv")
