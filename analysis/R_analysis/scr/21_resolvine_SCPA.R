# AIM ---------------------------------------------------------------------
# test by scpa the enrichment of modules of genes
...
#   filter(grepl(paste(pathways_id, collapse = "|"), gs_name, ignore.case = T)) %>%
#   format_pathways()

pathways <- list(set_01,set_02)
...
write_tsv(x = SCPA_BASELINE,file = "../../out/table/SCPA_vs_BASELINE_all_resolvine.tsv")
...
SCPA_BASELINE <- read_tsv(file = "../../out/table/SCPA_vs_BASELINE_all_resolvine.tsv")
