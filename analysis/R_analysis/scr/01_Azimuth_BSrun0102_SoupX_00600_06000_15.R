...
# list_query2 <- readRDS("../../out/object/list_datasc_fix_filter_norm_doubletSinglet_SoupX_00600_06000_15.rds")
# 
# list_diet2 <- lapply(list_query2,function(x){
#   # track the process
#   print(x)
#   DefaultAssay(x) <- "RNA"
...
# saveRDS(list_diet2,"../../out/object/diet.list_datasc_fix_filter_norm_doubletSinglet_SoupX_00600_06000_15.rds")
...
# run azimuth -------------------------------------------------------------
list_diet <- readRDS("../../out/object/diet.list_datasc_fix_filter_norm_doubletSinglet_SoupX_00600_06000_15.rds")
...
saveRDS(list_azimuth,"../../out/object/list_out_Azimuth_BSrun0102_SoupX_00600_06000_15.rds")
