...
ggsave("../../out/image/33_Histogram_annotationConfident_MT3_count.pdf",width = 6,height = 5)
...
ggsave("../../out/image/33_UMAPSeurat_annotationConfident_MT3_count.pdf",width = 6,height = 5)
...
ggsave(plot = p01,filename = "../../out/image/33_UMAPSeuratNebulosa_annotationConfident_MT3_count.pdf",width = 12,height = 10)
...
# save the table
df_avg %>%
  write_tsv("../../out/table/33_df_avg_cellTypeTreat_MT3_BS03.tsv")
...
ggsave("../../out/image/33_avgExp_cellid_annotationConfident_MT3.pdf",width = 6,height = 5)
...
df_avg |>
  ...
  theme(strip.background = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA))+
  facet_wrap(~gene,scales = "free")
ggsave("../../out/image/33_avgExp_treat_annotationConfident_MT3.pdf",width = 6,height = 5)
...
ggsave("../../out/image/33_avgExpSplit_annotationConfident_MT3.pdf",width = 12,height = 5)
...
# scale_fill_viridis_c(option = "plasma",name="log10 number \nof cells")
ggsave("../../out/image/33_avgExp_donor_annotationConfident_MT3.pdf",width = 9,height = 5)
...
ggsave("../../out/image/33_DEvsAll_MT3_sc.pdf",width = 20,height = 6)
...
ggsave("../../out/image/33_DEtreat_minpct5_logfcthr01_refBASELINE_MT3.pdf",width = 17,height = 15)
...
df_gene_dist %>%
  ...
  labs(x = "Mean log-normalised expression across all cells (log10)",
       y = "Number of genes")
ggsave("../../out/image/33_geneDistribution_MT3_GOI_overall.pdf", width = 7, height = 5)
