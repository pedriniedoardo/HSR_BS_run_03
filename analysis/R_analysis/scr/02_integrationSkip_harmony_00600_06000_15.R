...
data.list <- readRDS("../../out/object/list_datasc_fix_filter_norm_doubletSinglet_SoupX_00600_06000_15.rds")
...
# check the scale matrix. it should be empty atm.
...
saveRDS(sobj_total_h,"../../out/object/data.combined_harmonySkipIntegration_AllSoupX_00600_06000_15.rds")
