# AIM ---------------------------------------------------------------------
# this is the updated script for the generation of the modules scores in the senescence signature
...
lapply(names(list_sig),function(x){
  ...
  df_meta %>% 
    write_tsv(paste0("../../out/table/modules_SENESCENCE_update/06_Module_score_",x,".tsv"))
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,".pdf"),width = 18,height = 3)
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,".png"),width = 18,height = 3)
  ...
  data2 %>%
    ...
    # scale_color_gradientn(colours = c("blue","gray","red"))
    scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_split_",x,".pdf"),width = 32,height = 30)
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_split_",x,".png"),width = 32,height = 30)
  ...
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_dist_score_ridges_",x,".pdf"),width = 12,height =9)
  ...
  data2 %>%
    ...
    # scale_fill_manual(values = c("green","yellow","red"))+
    theme(strip.background = element_blank(),axis.text.x = element_text(hjust = 1,angle = 90))
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_violin_score_",x,".pdf"),width = 9,height = 9)
  ...
  # scale_color_gradientn(colours = viridis::turbo(10))
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,"_tailored1.pdf"),width = 11,height = 10)
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,"_tailored1.png"),width = 11,height = 10,bg="white")
  ...
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,"_tailored2.pdf"),width = 11,height = 10)
  ggsave(paste0("../../out/image/modules_SENESCENCE_update/06_UMAP_score_",x,"_tailored2.png"),width = 11,height = 10,bg="white")
})
...
library(UpSetR)
pdf("../../out/image/modules_SENESCENCE_update/06_upset_signatures_shortlist_SENESCENCE.pdf",width = 15,height = 12,onefile = F)
...
df_int %>%
  write_tsv("../../out/table/modules_SENESCENCE_update/06_upset_signatures_shortlist_intersection_SENESCENCE.tsv")
