...
# 
# # generate the diat object and save it
# # save the coordiantes of the UMAP
# data.combined@reductions$umap@cell.embeddings %>%
#   data.frame() %>%
#   rownames_to_column("barcode") %>%
#   write_tsv("out/table/data.combined_NOT_annotated_fix_normalized_CoordUMAP_resolution_DoubletSinglet_harmonyMartina.tsv")
# 
# DefaultAssay(data.combined) <- "RNA"
# object_diet <- DietSeurat(object = data.combined, assays = "RNA")
# saveRDS(object_diet,"out/object/diet_data.combined_NOT_annotated_norm_fix_DoubletSinglet_harmonyMartina.rds")

# available datasets ------------------------------------------------------
# available_data <- AvailableData()
# # InstallData("humancortexref")
# # install the packages with the reference for the fetus dataset
# install.packages("../../data/azimuth/humancortexref.SeuratData_1.0.0.tar.gz")
# reference <- LoadReference(path = "renv/library/R-4.2/x86_64-conda-linux-gnu/humancortexref.SeuratData/azimuth/")
# 
# # save the reference umap
# df_point <- reference$map@reductions$refUMAP@cell.embeddings %>%
#   data.frame() %>%
#   rownames_to_column("barcode")
# write_tsv(df_point,"../../out/table/azimuth_humancortex_CoordUMAP.tsv")
# 
# # save the meta of the ref
# df_meta <- reference$map@meta.data %>%
#   data.frame() %>%
#   rownames_to_column("barcode")
# write_tsv(df_meta,"../../out/table/azimuth_humancortex_Metadata.tsv")

# run azimuth -------------------------------------------------------------
query <- LoadFileInput("../../out/object/data.combined_harmonySkipIntegration_AllSoupX_01000_06000_15.rds")
...
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_score_075.pdf",height = 4,width = 4)
...
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_ridges_score_075.pdf",height = 5,width = 4)
...
meta_query %>%
  ...
  theme(axis.text.x = element_text(hjust = 1,angle = 45)) + 
  geom_hline(yintercept = 0.75,col="red")
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_class_score_075.pdf",height = 4,width = 2)
...
meta_query %>%
  ...
  geom_hline(yintercept = 0.75,col="red")
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_cluster_score_075.pdf",height = 4,width = 6)
...
pdf("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_Heatmap_075.pdf",height = 4,width = 4)
...
pdf("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_HeatmapFilter_075.pdf",height = 4,width = 5)
...
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_UMAP_075.pdf",height = 5,width = 3)
...
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthHumanCortexRef_subclass_split_UMAP_075.pdf",height = 15,width = 20)
...
ggsave("../../out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075.pdf",width = 9,height = 6)
...
ggsave("../../out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075_split.pdf",width = 20,height = 15)
...
ggsave("../../out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075_subclass.pdf",width = 8,height = 6)
...
ggsave("../../out/image/human_motorcortexv1.0.0_subclass_data.combined_annotated_norm_fix_resolution_UMAP_075_subclass_split.pdf",width = 20,height = 15)

# -------------------------------------------------------------------------
# plot the annotation over the original data
# read in the original dataset
sobj <- readRDS("../../out/object/data.combined_harmonySkipIntegration_AllSoupX_01000_06000_15.rds")
...
ggsave("../../out/image/harmonySkipIntegration_AllSoupX_01000_06000_15_CoordUMAP_AzimuthBS_subclass_UMAP_075.pdf",height = 3,width = 5)
