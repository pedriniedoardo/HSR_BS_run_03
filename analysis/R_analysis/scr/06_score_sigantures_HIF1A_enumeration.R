...
# read in the data --------------------------------------------------------
folder <-  "../../out/table/modules_HIF1A/"
...
# save the table
df_en_090_final %>% 
  write_tsv("../../out/table/modules_HIF1A/06_enumeration_ALL_090_threshold_HIF1A.tsv")
...
ggsave(paste0("../../out/image/modules_HIF1A/06_enumeration_log2Prop_ALL_090_threshold_HIF1A.pdf"),width = 15,height =10)
...
# save the table
enumeration_cellID %>% 
  write_tsv("../../out/table/modules_HIF1A/06_enumeration_ALL_090_threshold_sampleWise_HIF1A.tsv")
...
ggsave("../../out/image/modules_HIF1A/06_enumeration_log2Prop_ALL_090_threshold_above5_sampleWise_HIF1A.pdf",width = 25,height =15)
...
enumeration_cellID %>%
  ...
  theme(strip.background = element_blank(),
        strip.text.y.right = element_text(angle = 0))+
  geom_hline(yintercept = 0.1,linetype="dotted",col="black")+theme(axis.text.x = element_text(hjust = 1,angle = 90))
ggsave("../../out/image/modules_HIF1A/06_enumeration_log2Prop_ALL_090_threshold_above5_sampleWise_small2_HIF1A.pdf",width = 25,height =20)
